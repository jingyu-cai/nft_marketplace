...
contract NFTMarketplace is ERC721URIStorage {
    ...
    function createListedToken(uint256 tokenId, uint256 price) private {
        ...
        idToListedToken[tokenId] = ListedToken(
            tokenId,
            payable(address(this)), // buyer is the contract instance itself 
                                    //   (storing the newly created NFT on the contract 
                                    //   before an actual user buys it)
            payable(msg.sender),
            price,
            true
        );
    ...
    function executeSale(uint256 tokenId) public payable {
        ...
        approve(address(this), tokenId); // owner (msg.sender) needs to approve this contract 
                                         //   to be able to sell this NFT in the future
